...
When Motoko code is compiled, a Candid interface file [(`.did`)](https://docs.internetcomputer.org/guides/canister-calls/candid#the-did-file) for the canister's public methods is automatically generated. This file is used to ensure data passed into and returned from these methods is automatically encoded to and decoded from Candid’s binary format.

Motoko canisters automatically handle the serialization and deserialization of data when the canister interacts with [inter-canister calls or ingress messages](https://docs.internetcomputer.org/references/message-execution-properties).
...
- [What is Candid?](https://docs.internetcomputer.org/guides/canister-calls/candid)
- [Using Candid](https://docs.internetcomputer.org/guides/canister-calls/candid)
- [Candid Specification](https://docs.internetcomputer.org/references/candid-spec)
