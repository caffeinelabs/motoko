...
While all shared types are stable, the reverse is not true. Some stable types cannot be shared across [canisters](https://docs.internetcomputer.org/concepts/canisters).
