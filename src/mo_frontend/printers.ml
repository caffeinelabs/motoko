...
let repr_of_symbol : xsymbol -> (string * string) =
  ...
  | X (N N_exp_bin_hd_bl_) | X (N N_exp_un_hd_bl_) | X (N N_exp_post_hd_bl_) | X (N N_exp_nullary_hd_) -> "<exp(hd)>", eg_exp
  ...
  | X (N N_exp_cont_ob_) | X (N N_exp_cont_bl_) | X (N N_exp_cont_call) -> "<exp_cont>", "(" ^ eg_exp ^ ")"
  | X (N N_exp_cont_juxta) -> "<exp_cont>", eg_exp
  | X (N N_paren_exp) -> "(<exp>)", "(" ^ eg_exp ^ ")"
  | X (N N_head_hd_) | X (N N_head_bl_) -> "<head>", eg_exp
  | X (N N_if_exp_ob_) | X (N N_if_exp_bl_) -> "<if_exp>", "if c {}"
  | X (N N_else_branch_ob_) | X (N N_else_branch_bl_) -> "<else_branch>", "{}"
