...
let type_error at : string -> Diag.message = Diag.error_message' at "" "type" ~spans:[] ~notes:[] ~edits:[]
let type_warning at : string -> Diag.message = Diag.warning_message' at "" "type" ~spans:[] ~notes:[] ~edits:[]
