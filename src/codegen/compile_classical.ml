...
module RTS = struct
  let incremental_gc_imports env =
    ...
    List.iter (fun (n, a, r) -> add_rts_import n a r) [
      "initialize_incremental_gc", [],              [];
      "schedule_incremental_gc",   [],              [];
      "incremental_gc",            [],              [];
      "write_with_barrier",        [I32Type; I32Type], [];
      "allocation_barrier",        [I32Type],       [I32Type];
      "stop_gc_on_upgrade",        [],              [];
      "running_gc",                [],              [I32Type];
    ]
  ...
  let non_incremental_gc_imports env =
    let add_rts_import = E.add_func_import env "rts" in
    List.iter (fun (n, a, r) -> add_rts_import n a r) [
      "initialize_copying_gc",     [], [];
      "initialize_compacting_gc",  [], [];
      "initialize_generational_gc",[], [];
      "schedule_copying_gc",       [], [];
      "schedule_compacting_gc",    [], [];
      "schedule_generational_gc",  [], [];
      "copying_gc",                [], [];
      "compacting_gc",             [], [];
      "generational_gc",           [], [];
      "post_write_barrier",        [I32Type], [];
    ]
  ...
  let system_imports env =
    let add_rts_import = E.add_func_import env "rts" in
    List.iter (fun (n, a, r) -> add_rts_import n a r) [
      "memcmp",                       [I32Type; I32Type; I32Type],                                           [I32Type];
      "version",                      [],                                                                    [I32Type];
      "parse_idl_header",             [I32Type; I32Type; I32Type; I32Type; I32Type; I32Type],                [];
      "idl_sub_buf_words",            [I32Type; I32Type],                                                    [I32Type];
      "idl_sub_buf_init",             [I32Type; I32Type; I32Type],                                           [];
      "idl_sub",                      [I32Type; I32Type; I32Type; I32Type; I32Type; I32Type; I32Type; I32Type; I32Type], [I32Type];
      "leb128_decode",                [I32Type],                                                             [I32Type];
      "sleb128_decode",               [I32Type],                                                             [I32Type];
      "bigint_of_word32",             [I32Type],                                                             [I32Type];
      "bigint_of_int32",              [I32Type],                                                             [I32Type];
      "bigint_to_word32_wrap",        [I32Type],                                                             [I32Type];
      "bigint_to_word32_trap",        [I32Type],                                                             [I32Type];
      "bigint_to_word32_trap_with",   [I32Type; I32Type],                                                    [I32Type];
      "bigint_of_word64",             [I64Type],                                                             [I32Type];
      "bigint_of_int64",              [I64Type],                                                             [I32Type];
      "bigint_of_float64",            [F64Type],                                                             [I32Type];
      "bigint_to_float64",            [I32Type],                                                             [F64Type];
      "bigint_to_word64_wrap",        [I32Type],                                                             [I64Type];
      "bigint_to_word64_trap",        [I32Type],                                                             [I64Type];
      "bigint_eq",                    [I32Type; I32Type],                                                    [I32Type];
      "bigint_isneg",                 [I32Type],                                                             [I32Type];
      "bigint_count_bits",            [I32Type],                                                             [I32Type];
      "bigint_2complement_bits",      [I32Type],                                                             [I32Type];
      "bigint_lt",                    [I32Type; I32Type],                                                    [I32Type];
      "bigint_gt",                    [I32Type; I32Type],                                                    [I32Type];
      "bigint_le",                    [I32Type; I32Type],                                                    [I32Type];
      "bigint_ge",                    [I32Type; I32Type],                                                    [I32Type];
      "bigint_add",                   [I32Type; I32Type],                                                    [I32Type];
      "bigint_sub",                   [I32Type; I32Type],                                                    [I32Type];
      "bigint_mul",                   [I32Type; I32Type],                                                    [I32Type];
      "bigint_rem",                   [I32Type; I32Type],                                                    [I32Type];
      "bigint_div",                   [I32Type; I32Type],                                                    [I32Type];
      "bigint_pow",                   [I32Type; I32Type],                                                    [I32Type];
      "bigint_neg",                   [I32Type],                                                             [I32Type];
      "bigint_lsh",                   [I32Type; I32Type],                                                    [I32Type];
      "bigint_rsh",                   [I32Type; I32Type],                                                    [I32Type];
      "bigint_abs",                   [I32Type],                                                             [I32Type];
      "bigint_leb128_size",           [I32Type],                                                             [I32Type];
      "bigint_leb128_encode",         [I32Type; I32Type],                                                    [];
      "bigint_leb128_stream_encode",  [I32Type; I32Type],                                                    [];
      "bigint_leb128_decode",         [I32Type],                                                             [I32Type];
      "bigint_leb128_decode_word64",  [I64Type; I64Type; I32Type],                                          [I32Type];
      "bigint_sleb128_size",          [I32Type],                                                             [I32Type];
      "bigint_sleb128_encode",        [I32Type; I32Type],                                                    [];
      "bigint_sleb128_stream_encode", [I32Type; I32Type],                                                    [];
      "bigint_sleb128_decode",        [I32Type],                                                             [I32Type];
      "bigint_sleb128_decode_word64", [I64Type; I64Type; I32Type],                                          [I32Type];
      "leb128_encode",                [I32Type; I32Type],                                                    [];
      "sleb128_encode",               [I32Type; I32Type],                                                    [];
      "utf8_valid",                   [I32Type; I32Type],                                                    [I32Type];
      "utf8_validate",                [I32Type; I32Type],                                                    [];
      "skip_leb128",                  [I32Type],                                                             [];
      "skip_any",                     [I32Type; I32Type; I32Type; I32Type],                                  [];
      "find_field",                   [I32Type; I32Type; I32Type; I32Type; I32Type],                         [I32Type];
      "skip_fields",                  [I32Type; I32Type; I32Type; I32Type],                                  [];
      "remember_continuation",        [I32Type],                                                             [I32Type];
      "recall_continuation",          [I32Type],                                                             [I32Type];
      "peek_future_continuation",     [I32Type],                                                             [I32Type];
      "continuation_count",           [],                                                                    [I32Type];
      "continuation_table_size",      [],                                                                    [I32Type];
      "blob_of_text",                 [I32Type],                                                             [I32Type];
      "text_compare",                 [I32Type; I32Type],                                                    [I32Type];
      "text_concat",                  [I32Type; I32Type],                                                    [I32Type];
      "text_iter_done",               [I32Type],                                                             [I32Type];
      "text_iter",                    [I32Type],                                                             [I32Type];
      "text_iter_next",               [I32Type],                                                             [I32Type];
      "text_len",                     [I32Type],                                                             [I32Type];
      "text_of_ptr_size",             [I32Type; I32Type],                                                    [I32Type];
      "text_singleton",               [I32Type],                                                             [I32Type];
      "text_size",                    [I32Type],                                                             [I32Type];
      "text_to_buf",                  [I32Type; I32Type],                                                    [];
      "text_lowercase",               [I32Type],                                                             [I32Type];
      "text_uppercase",               [I32Type],                                                             [I32Type];
      "region_init",                  [I32Type],                                                             [];
      "alloc_region",                 [I64Type; I32Type; I32Type],                                          [I32Type];
      "init_region",                  [I32Type; I64Type; I32Type; I32Type],                                  [];
      "region_new",                   [],                                                                    [I32Type];
      "region_id",                    [I32Type],                                                             [I64Type];
      "region_page_count",            [I32Type],                                                             [I32Type];
      "region_vec_pages",             [I32Type],                                                             [I32Type];
      "region_size",                  [I32Type],                                                             [I64Type];
      "region_grow",                  [I32Type; I64Type],                                                    [I64Type];
      "region_load_blob",             [I32Type; I64Type; I32Type],                                          [I32Type];
      "region_store_blob",            [I32Type; I64Type; I32Type],                                          [];
      "region_load_word8",            [I32Type; I64Type],                                                    [I32Type];
      "region_store_word8",           [I32Type; I64Type; I32Type],                                          [];
      "region_load_word16",           [I32Type; I64Type],                                                    [I32Type];
      "region_store_word16",          [I32Type; I64Type; I32Type],                                          [];
      "region_load_word32",           [I32Type; I64Type],                                                    [I32Type];
      "region_store_word32",          [I32Type; I64Type; I32Type],                                          [];
      "region_load_word64",           [I32Type; I64Type],                                                    [I64Type];
      "region_store_word64",          [I32Type; I64Type; I64Type],                                          [];
      "region_load_float64",          [I32Type; I64Type],                                                    [F64Type];
      "region_store_float64",         [I32Type; I64Type; F64Type],                                          [];
      "region0_get",                  [],                                                                    [I32Type];
      "blob_of_principal",            [I32Type],                                                             [I32Type];
      "principal_of_blob",            [I32Type],                                                             [I32Type];
      "compute_crc32",                [I32Type],                                                             [I32Type];
      "blob_iter_done",               [I32Type],                                                             [I32Type];
      "blob_iter",                    [I32Type],                                                             [I32Type];
      "blob_iter_next",               [I32Type],                                                             [I32Type];
      "pow",                          [F64Type; F64Type],                                                    [F64Type];
      "sin",                          [F64Type],                                                             [F64Type];
      "cos",                          [F64Type],                                                             [F64Type];
      "tan",                          [F64Type],                                                             [F64Type];
      "asin",                         [F64Type],                                                             [F64Type];
      "acos",                         [F64Type],                                                             [F64Type];
      "atan",                         [F64Type],                                                             [F64Type];
      "atan2",                        [F64Type; F64Type],                                                    [F64Type];
      "exp",                          [F64Type],                                                             [F64Type];
      "log",                          [F64Type],                                                             [F64Type];
      "fmod",                         [F64Type; F64Type],                                                    [F64Type];
      "fmodf",                        [F32Type; F32Type],                                                    [F32Type];
      "float_fmt",                    [F64Type; I32Type; I32Type],                                          [I32Type];
      "char_to_upper",                [I32Type],                                                             [I32Type];
      "char_to_lower",                [I32Type],                                                             [I32Type];
      "char_is_whitespace",           [I32Type],                                                             [I32Type];
      "char_is_lowercase",            [I32Type],                                                             [I32Type];
      "char_is_uppercase",            [I32Type],                                                             [I32Type];
      "char_is_alphabetic",           [I32Type],                                                             [I32Type];
      "get_max_live_size",            [],                                                                    [I32Type];
      "get_reclaimed",                [],                                                                    [I64Type];
      "alloc_words",                  [I32Type],                                                             [I32Type];
      "get_total_allocations",        [],                                                                    [I64Type];
      "get_heap_size",                [],                                                                    [I32Type];
      "alloc_blob",                   [I32Type; I32Type],                                                    [I32Type];
      "alloc_array",                  [I32Type; I32Type],                                                    [I32Type];
      "alloc_stream",                 [I32Type],                                                             [I32Type];
      "stream_write",                 [I32Type; I32Type; I32Type],                                          [];
      "stream_write_byte",            [I32Type; I32Type],                                                    [];
      "stream_write_text",            [I32Type; I32Type],                                                    [];
      "stream_split",                 [I32Type],                                                             [I32Type];
      "stream_shutdown",              [I32Type],                                                             [];
      "stream_reserve",               [I32Type; I32Type],                                                    [I32Type];
      "stream_stable_dest",           [I32Type; I64Type; I64Type],                                          [];
    ];
...
module Heap = struct
  ...
  let load_field_float32 (i : int32) : G.t =
    let offset = Int32.(add (mul word_size i) ptr_unskew) in
    G.i (Load {ty = F32Type; align = 2; offset = Int64.of_int32 offset; sz = None})

  let store_field_float32 (i : int32) : G.t =
    let offset = Int32.(add (mul word_size i) ptr_unskew) in
    G.i (Store {ty = F32Type; align = 2; offset = Int64.of_int32 offset; sz = None})
...
module Tagged = struct
  ...
  let load_field_float32 env index =
    (if !Flags.sanity then check_forwarding env false else G.nop) ^^
    Heap.load_field_float32 index

  let store_field_float32 env index =
    (if !Flags.sanity then check_forwarding_for_store env F32Type else G.nop) ^^
    Heap.store_field_float32 index
...
module Float32 = struct
  (* We store Float32 values in immutable boxed 32-bit heap objects.
  ...
  *)
  ...
  let compile_unboxed_const f =
    G.i (Const (nr (Wasm.Values.F32 (Wasm.F32.of_bits (Int32.bits_of_float (Numerics.Float32.to_float f))))))

  let vanilla_lit env f =
    Tagged.shared_static_obj env Tagged.(Bits32 F) StaticBytes.[
      I32 (Int32.bits_of_float (Numerics.Float32.to_float f))
    ]

  let box env = Func.share_code1 Func.Never env "box_f32" ("f", F32Type) [I32Type] (fun env get_f ->
    let (set_i, get_i) = new_local env "boxed_f32" in
    let size = Int32.add (Tagged.header_size env) 1l in
    Tagged.alloc env size Tagged.(Bits32 F) ^^
    set_i ^^
    get_i ^^ get_f ^^ Tagged.store_field_float32 env (payload_field env) ^^
    get_i ^^
    Tagged.allocation_barrier env
  )
  ...
  let unbox env =
    Tagged.load_forwarding_pointer env ^^
    Tagged.(sanity_check_tag __LINE__ env (Bits32 F)) ^^
    Tagged.load_field_float32 env (payload_field env)
...
module Blob = struct
  ...
  *)
  ...
  let idx env =
    Func.share_code2 Func.Never env "Blob.idx" (("blob", I32Type), ("idx", I32Type)) [I32Type] (fun env get_blob get_idx ->
  ...
  let idx_bigint env =
    Func.share_code2 Func.Never env "Blob.idx_bigint" (("blob", I32Type), ("idx", I32Type)) [I32Type] (fun env get_blob get_idx ->
      get_blob ^^
      get_idx ^^
      lit env Tagged.T "Blob index out of bounds" ^^
...
module StackRep = struct
  ...
  *)
  let materialize_lit env (lit : Const.lit) : int32 =
    ...
    | Const.Float32 f  -> Float32.vanilla_lit env f
  ...
  let adjust env (sr_in : t) sr_out =
    ...
    | Const (_, Const.Lit (Const.Float32 f)), UnboxedFloat32 -> Float32.compile_unboxed_const f
...
and compile_prim_invocation (env : E.t) ae p es at =
  ...
  | OtherPrim "rts_in_upgrade", [] -> (* classical specific *)
